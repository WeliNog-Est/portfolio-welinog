...
<div class="project-card">
  <div class="project-title">📊 Análise SINASC — Saúde Pública</div>
  <div class="project-tech">R · R Markdown · Estatística · Dados Públicos</div>
  <p>
  ...
  <a class="project-link"
     href="https://welinog-est.github.io/portfolio-welinog/consultoria/SINASC/"
     target="_blank">
     Abrir visualização →
  </a>
</div>
